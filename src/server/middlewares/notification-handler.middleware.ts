...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Job Proposal Submission.create': {
    roles: ['admin', 'recruiter'],
    key: 'job_proposal_submission',
    tenantPath: [],
    userPath: [],
  },
  'Freelancer Shortlisted.update': {
    roles: ['admin', 'recruiter'],
    key: 'freelancer_shortlisted',
    tenantPath: [],
    userPath: [],
  },
  'Proposal Approved.update': { roles: ['admin', 'recruiter'], key: 'proposal_approved', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['admin'];
const customerRoles: string[] = ['freelancer'];
const tenantRoles: string[] = ['admin', 'recruiter'];
