...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Foox again`}</title>

        <meta
          name="description"
          content="Foox again - Bridging the Gap Between Freelancers and Companies Offering Jobs, Empowering You to Find the Perfect Match in the Marketplace"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1527192491265-7e15c55b1ed2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmcmVlbGFuY2Vyc3xlbnwwfHx8fDE2OTUyMjI0NzF8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Foox again - Bridging the Gap Between Freelancers and Companies Offering Jobs, Empowering You to Find the Perfect Match in the Marketplace`}
            </Text>
            <Box
